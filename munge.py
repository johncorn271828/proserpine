...
class GhcndMunger:
    ...
    def __init__(self):
        ...
        self.training_station_ids = [# STATE                         NAME 
        ...
        self.stations = self.stations[
            self.stations["ID"].isin(self.training_station_ids)]
        ...
        #After that, there are 4 components times 31 days. Append these numbered column
        # names to the schema above
        column_index = 21
        for i in range(1,32):
    ...
    def plot_stations(self):
        ...
        m.drawcoastlines()
        m.drawcountries()
        lons = self.stations["LONGITUDE"].tolist()
        lats = self.stations["LATITUDE"].tolist()
        x, y = m(lons, lats)
    ...
    def munge(self, start_month=2, end_month=11, enough_days=15):
        ...
        seasons = []
        bad_months = {station_id : 0 for station_id in self.training_station_ids}
